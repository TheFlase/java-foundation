...
public class MyArrayListTest {
    public static void main(String[] args) {
        ...
        MyIterator<Integer> it = myArrayList.iterator();
        ...
        System.out.println("\n 移除不存在:" + myArrayList.removeObj(999));
        System.out.println("\n 移除 null:" + myArrayList.removeObj(null));

        myArrayList.add(null);
        MyIterator<Integer> it2 = myArrayList.iterator();
        System.out.println("含 null 的迭代:");
        while (it2.hasNext()) {
